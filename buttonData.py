...
fields = [“button_state”,”name”] # Your feed's data fields

######################
## I/O Stuff & Misc ##
######################
buttonPin = 4 # Active-high button connected to Broadcom pin 4
...
GPIO.setup(buttonPin, GPIO.IN, pull_up_down=GPIO.PUD_DOWN) # Button pin set as input w/ pull-down
